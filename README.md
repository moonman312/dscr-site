...
Audience-specific landing site for **debtservicecoverageratios.com**, bundling the Hotel Capital Stack diagnostic. Static — no build step.
...
```bash
git init && git add . && git commit -m "DSCR Calculator & Guide site"
git branch -M main
gh repo create moonman312/dscr-site --public --source=. --remote=origin --push
vercel && vercel --prod
```

## Domains for this project (add in Vercel → Settings → Domains)
- Primary: **debtservicecoverageratios.com**
